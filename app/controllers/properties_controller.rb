class PropertiesController < ApplicationController
  ...
  def index
    ...
    respond_to do |format|
      format.html
      format.csv {send_data @properties.export }
    end
  end
  ...
  def import
    ...
    redirect_to properties_path, notice: "Properties added!"
  end
  ...
  private
    ...
    def property_params
      params.require(:property).permit(:name, :addr1, :addr2, :city, :state, :zip)
    end
end
